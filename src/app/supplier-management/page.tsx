              ...
              <tbody>
                ...
                {filtered.map((supplier) => (
                  ...
                  >
                    ...
                    <td className="px-4 py-4 text-sm text-[var(--cela-stone)] font-mono">
                      {supplier.taxCode || "—"}
                    </td>{" "}
            ...
            <form onSubmit={handleSave} className="p-6 space-y-4">
              ...
              <div>
                ...
                <label className="block text-sm font-medium text-[var(--cela-cocoa)] mb-1.5">
                  {" "}
                  Tên <span className="text-[var(--cela-danger)]">*</span>{" "}
                </label>{" "}
                <input
                  type="text"
                  value={form.name}
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full h-10 rounded-lg px-3 text-sm font-mono focus:outline-none focus:ring-2 focus:ring-[rgba(183,110,121,0.18)] focus:border-[var(--cela-rose)]"
                  style={{
                    border: "1px solid var(--cela-mist)",
                  }}
                />{" "}
